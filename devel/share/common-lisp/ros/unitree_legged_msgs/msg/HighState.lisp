...
(cl:defmethod header-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:header-val is deprecated.  Use unitree_legged_msgs-msg:header instead.")
  (header m))

...
(cl:defmethod cl:initialize-instance :after ((m <Cartesian>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cartesian)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_pose_slam-msg:<Cartesian> is deprecated: use a1_pose_slam-msg:Cartesian instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:x-val is deprecated.  Use a1_pose_slam-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:y-val is deprecated.  Use a1_pose_slam-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'z-val :lambda-list '(m))
(cl:defmethod z-val ((m <Cartesian>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:z-val is deprecated.  Use a1_pose_slam-msg:z instead.")
  (z m))

...
(cl:defclass <HighCmd> (roslisp-msg-protocol:ros-message)
  ((levelFlag
   ...
   (led
    :reader led
    :initarg :led
    :type (cl:vector a1_pose_slam-msg:LED)
   :initform (cl:make-array 4 :element-type 'a1_pose_slam-msg:LED :initial-element (cl:make-instance 'a1_pose_slam-msg:LED)))
   (wirelessRemote
...
(cl:defmethod cl:initialize-instance :after ((m <HighCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HighCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_pose_slam-msg:<HighCmd> is deprecated: use a1_pose_slam-msg:HighCmd instead.")))
...
(cl:defmethod footRaiseHeight-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:footRaiseHeight-val is deprecated.  Use a1_pose_slam-msg:footRaiseHeight instead.")
  (footRaiseHeight m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:yaw-val is deprecated.  Use a1_pose_slam-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'pitch-val :lambda-list '(m))
(cl:defmethod pitch-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:pitch-val is deprecated.  Use a1_pose_slam-msg:pitch instead.")
  (pitch m))

(cl:ensure-generic-function 'roll-val :lambda-list '(m))
(cl:defmethod roll-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:roll-val is deprecated.  Use a1_pose_slam-msg:roll instead.")
  (roll m))

(cl:ensure-generic-function 'led-val :lambda-list '(m))
(cl:defmethod led-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:led-val is deprecated.  Use a1_pose_slam-msg:led instead.")
  (led m))
...
(cl:defmethod AppRemote-val ((m <HighCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:AppRemote-val is deprecated.  Use a1_pose_slam-msg:AppRemote instead.")
  (AppRemote m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HighCmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'led)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'a1_pose_slam-msg:LED))

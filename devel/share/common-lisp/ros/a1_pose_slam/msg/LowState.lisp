...
(cl:defclass <LowState> (roslisp-msg-protocol:ros-message)
  ((levelFlag
   ...
   (motorState
    :reader motorState
    :initarg :motorState
    :type (cl:vector a1_pose_slam-msg:MotorState)
   :initform (cl:make-array 20 :element-type 'a1_pose_slam-msg:MotorState :initial-element (cl:make-instance 'a1_pose_slam-msg:MotorState)))
   (footForce
    :reader footForce
    :initarg :footForce
   ...
   (position
    :reader position
    :initarg :position
    :type a1_pose_slam-msg:Cartesian
    :initform (cl:make-instance 'a1_pose_slam-msg:Cartesian))
   (velocity
    :reader velocity
    :initarg :velocity
    :type a1_pose_slam-msg:Cartesian
...
(cl:defmethod cl:initialize-instance :after ((m <LowState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LowState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_pose_slam-msg:<LowState> is deprecated: use a1_pose_slam-msg:LowState instead.")))
...
(cl:defmethod motorState-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:motorState-val is deprecated.  Use a1_pose_slam-msg:motorState instead.")
  (motorState m))
...
(cl:defmethod eeForceRaw-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:eeForceRaw-val is deprecated.  Use a1_pose_slam-msg:eeForceRaw instead.")
  (eeForceRaw m))
...
(cl:defmethod position-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:position-val is deprecated.  Use a1_pose_slam-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:velocity-val is deprecated.  Use a1_pose_slam-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'velocity_w-val :lambda-list '(m))
(cl:defmethod velocity_w-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:velocity_w-val is deprecated.  Use a1_pose_slam-msg:velocity_w instead.")
  (velocity_w m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LowState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motorState)))
    (cl:dotimes (i 20)
    (cl:setf (cl:aref vals i) (cl:make-instance 'a1_pose_slam-msg:MotorState))

...
(cl:defclass <LowCmd> (roslisp-msg-protocol:ros-message)
  ((levelFlag
   ...
   (motorCmd
    :reader motorCmd
    :initarg :motorCmd
    :type (cl:vector a1_pose_slam-msg:MotorCmd)
   :initform (cl:make-array 20 :element-type 'a1_pose_slam-msg:MotorCmd :initial-element (cl:make-instance 'a1_pose_slam-msg:MotorCmd)))
   (led
    :reader led
    :initarg :led
...
(cl:defmethod cl:initialize-instance :after ((m <LowCmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LowCmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_pose_slam-msg:<LowCmd> is deprecated: use a1_pose_slam-msg:LowCmd instead.")))
...
(cl:defmethod motorCmd-val ((m <LowCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:motorCmd-val is deprecated.  Use a1_pose_slam-msg:motorCmd instead.")
  (motorCmd m))
...
(cl:defmethod ff-val ((m <LowCmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:ff-val is deprecated.  Use a1_pose_slam-msg:ff instead.")
  (ff m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LowCmd>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motorCmd)))
    (cl:dotimes (i 20)
    (cl:setf (cl:aref vals i) (cl:make-instance 'a1_pose_slam-msg:MotorCmd))

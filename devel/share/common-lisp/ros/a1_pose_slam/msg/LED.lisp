...
(cl:defmethod cl:initialize-instance :after ((m <LED>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LED)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_pose_slam-msg:<LED> is deprecated: use a1_pose_slam-msg:LED instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <LED>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:r-val is deprecated.  Use a1_pose_slam-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <LED>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:g-val is deprecated.  Use a1_pose_slam-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <LED>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_pose_slam-msg:b-val is deprecated.  Use a1_pose_slam-msg:b instead.")
  (b m))

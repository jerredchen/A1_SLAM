...
(cl:defmethod cl:initialize-instance :after ((m <IMU>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMU)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_slam-msg:<IMU> is deprecated: use a1_slam-msg:IMU instead.")))

(cl:ensure-generic-function 'quaternion-val :lambda-list '(m))
(cl:defmethod quaternion-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:quaternion-val is deprecated.  Use a1_slam-msg:quaternion instead.")
  (quaternion m))

(cl:ensure-generic-function 'gyroscope-val :lambda-list '(m))
(cl:defmethod gyroscope-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:gyroscope-val is deprecated.  Use a1_slam-msg:gyroscope instead.")
  (gyroscope m))

(cl:ensure-generic-function 'accelerometer-val :lambda-list '(m))
(cl:defmethod accelerometer-val ((m <IMU>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:accelerometer-val is deprecated.  Use a1_slam-msg:accelerometer instead.")
  (accelerometer m))

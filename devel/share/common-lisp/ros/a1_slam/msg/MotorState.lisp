...
(cl:defmethod cl:initialize-instance :after ((m <MotorState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_slam-msg:<MotorState> is deprecated: use a1_slam-msg:MotorState instead.")))
...
(cl:defmethod q-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:q-val is deprecated.  Use a1_slam-msg:q instead.")
  (q m))

(cl:ensure-generic-function 'dq-val :lambda-list '(m))
(cl:defmethod dq-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:dq-val is deprecated.  Use a1_slam-msg:dq instead.")
  (dq m))

(cl:ensure-generic-function 'ddq-val :lambda-list '(m))
(cl:defmethod ddq-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:ddq-val is deprecated.  Use a1_slam-msg:ddq instead.")
  (ddq m))

(cl:ensure-generic-function 'tauEst-val :lambda-list '(m))
(cl:defmethod tauEst-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:tauEst-val is deprecated.  Use a1_slam-msg:tauEst instead.")
  (tauEst m))

(cl:ensure-generic-function 'q_raw-val :lambda-list '(m))
(cl:defmethod q_raw-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:q_raw-val is deprecated.  Use a1_slam-msg:q_raw instead.")
  (q_raw m))

(cl:ensure-generic-function 'dq_raw-val :lambda-list '(m))
(cl:defmethod dq_raw-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:dq_raw-val is deprecated.  Use a1_slam-msg:dq_raw instead.")
  (dq_raw m))

(cl:ensure-generic-function 'ddq_raw-val :lambda-list '(m))
(cl:defmethod ddq_raw-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:ddq_raw-val is deprecated.  Use a1_slam-msg:ddq_raw instead.")
  (ddq_raw m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <MotorState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:temperature-val is deprecated.  Use a1_slam-msg:temperature instead.")
  (temperature m))

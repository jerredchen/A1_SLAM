...
(cl:defclass <HighState> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (imu
    :reader imu
    :initarg :imu
    :type a1_slam-msg:IMU
    :initform (cl:make-instance 'a1_slam-msg:IMU))
   (forwardSpeed
    :reader forwardSpeed
   ...
   (footPosition2Body
    ...
    :type (cl:vector a1_slam-msg:Cartesian)
   :initform (cl:make-array 4 :element-type 'a1_slam-msg:Cartesian :initial-element (cl:make-instance 'a1_slam-msg:Cartesian)))
   (footSpeed2Body
...
(cl:defmethod cl:initialize-instance :after ((m <HighState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'HighState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name a1_slam-msg:<HighState> is deprecated: use a1_slam-msg:HighState instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:header-val is deprecated.  Use a1_slam-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'levelFlag-val :lambda-list '(m))
(cl:defmethod levelFlag-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:levelFlag-val is deprecated.  Use a1_slam-msg:levelFlag instead.")
  (levelFlag m))

(cl:ensure-generic-function 'commVersion-val :lambda-list '(m))
(cl:defmethod commVersion-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:commVersion-val is deprecated.  Use a1_slam-msg:commVersion instead.")
  (commVersion m))

(cl:ensure-generic-function 'robotID-val :lambda-list '(m))
(cl:defmethod robotID-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:robotID-val is deprecated.  Use a1_slam-msg:robotID instead.")
  (robotID m))

(cl:ensure-generic-function 'SN-val :lambda-list '(m))
(cl:defmethod SN-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:SN-val is deprecated.  Use a1_slam-msg:SN instead.")
  (SN m))

(cl:ensure-generic-function 'bandWidth-val :lambda-list '(m))
(cl:defmethod bandWidth-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:bandWidth-val is deprecated.  Use a1_slam-msg:bandWidth instead.")
  (bandWidth m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:mode-val is deprecated.  Use a1_slam-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'imu-val :lambda-list '(m))
(cl:defmethod imu-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:imu-val is deprecated.  Use a1_slam-msg:imu instead.")
  (imu m))

(cl:ensure-generic-function 'forwardSpeed-val :lambda-list '(m))
(cl:defmethod forwardSpeed-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:forwardSpeed-val is deprecated.  Use a1_slam-msg:forwardSpeed instead.")
  (forwardSpeed m))

(cl:ensure-generic-function 'sideSpeed-val :lambda-list '(m))
(cl:defmethod sideSpeed-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:sideSpeed-val is deprecated.  Use a1_slam-msg:sideSpeed instead.")
  (sideSpeed m))

(cl:ensure-generic-function 'rotateSpeed-val :lambda-list '(m))
(cl:defmethod rotateSpeed-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:rotateSpeed-val is deprecated.  Use a1_slam-msg:rotateSpeed instead.")
  (rotateSpeed m))

(cl:ensure-generic-function 'bodyHeight-val :lambda-list '(m))
(cl:defmethod bodyHeight-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:bodyHeight-val is deprecated.  Use a1_slam-msg:bodyHeight instead.")
  (bodyHeight m))

(cl:ensure-generic-function 'updownSpeed-val :lambda-list '(m))
(cl:defmethod updownSpeed-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:updownSpeed-val is deprecated.  Use a1_slam-msg:updownSpeed instead.")
  (updownSpeed m))

(cl:ensure-generic-function 'forwardPosition-val :lambda-list '(m))
(cl:defmethod forwardPosition-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:forwardPosition-val is deprecated.  Use a1_slam-msg:forwardPosition instead.")
  (forwardPosition m))

(cl:ensure-generic-function 'sidePosition-val :lambda-list '(m))
(cl:defmethod sidePosition-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:sidePosition-val is deprecated.  Use a1_slam-msg:sidePosition instead.")
  (sidePosition m))

(cl:ensure-generic-function 'footPosition2Body-val :lambda-list '(m))
(cl:defmethod footPosition2Body-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:footPosition2Body-val is deprecated.  Use a1_slam-msg:footPosition2Body instead.")
  (footPosition2Body m))

(cl:ensure-generic-function 'footSpeed2Body-val :lambda-list '(m))
(cl:defmethod footSpeed2Body-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:footSpeed2Body-val is deprecated.  Use a1_slam-msg:footSpeed2Body instead.")
  (footSpeed2Body m))

(cl:ensure-generic-function 'footForce-val :lambda-list '(m))
(cl:defmethod footForce-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:footForce-val is deprecated.  Use a1_slam-msg:footForce instead.")
  (footForce m))

(cl:ensure-generic-function 'footForceEst-val :lambda-list '(m))
(cl:defmethod footForceEst-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:footForceEst-val is deprecated.  Use a1_slam-msg:footForceEst instead.")
  (footForceEst m))

(cl:ensure-generic-function 'tick-val :lambda-list '(m))
(cl:defmethod tick-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:tick-val is deprecated.  Use a1_slam-msg:tick instead.")
  (tick m))

(cl:ensure-generic-function 'wirelessRemote-val :lambda-list '(m))
(cl:defmethod wirelessRemote-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:wirelessRemote-val is deprecated.  Use a1_slam-msg:wirelessRemote instead.")
  (wirelessRemote m))

(cl:ensure-generic-function 'reserve-val :lambda-list '(m))
(cl:defmethod reserve-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:reserve-val is deprecated.  Use a1_slam-msg:reserve instead.")
  (reserve m))

(cl:ensure-generic-function 'crc-val :lambda-list '(m))
(cl:defmethod crc-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:crc-val is deprecated.  Use a1_slam-msg:crc instead.")
  (crc m))

(cl:ensure-generic-function 'eeForce-val :lambda-list '(m))
(cl:defmethod eeForce-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:eeForce-val is deprecated.  Use a1_slam-msg:eeForce instead.")
  (eeForce m))

(cl:ensure-generic-function 'jointP-val :lambda-list '(m))
(cl:defmethod jointP-val ((m <HighState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader a1_slam-msg:jointP-val is deprecated.  Use a1_slam-msg:jointP instead.")
  (jointP m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <HighState>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'footPosition2Body)))
    (cl:dotimes (i 4)
    (cl:setf (cl:aref vals i) (cl:make-instance 'a1_slam-msg:Cartesian))

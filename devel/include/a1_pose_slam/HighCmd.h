// Generated by gencpp from file a1_pose_slam/HighCmd.msg
// DO NOT EDIT!


#ifndef A1_POSE_SLAM_MESSAGE_HIGHCMD_H
#define A1_POSE_SLAM_MESSAGE_HIGHCMD_H
...
struct HighCmd_
{
  ...
  typedef boost::shared_ptr< ::a1_pose_slam::HighCmd_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::a1_pose_slam::HighCmd_<ContainerAllocator> const> ConstPtr;

}; // struct HighCmd_

typedef ::a1_pose_slam::HighCmd_<std::allocator<void> > HighCmd;

typedef boost::shared_ptr< ::a1_pose_slam::HighCmd > HighCmdPtr;
typedef boost::shared_ptr< ::a1_pose_slam::HighCmd const> HighCmdConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::a1_pose_slam::HighCmd_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::a1_pose_slam::HighCmd_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::a1_pose_slam::HighCmd_<ContainerAllocator1> & lhs, const ::a1_pose_slam::HighCmd_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::a1_pose_slam::HighCmd_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_pose_slam::HighCmd_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_pose_slam::HighCmd_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
{
  ...
  static const char* value(const ::a1_pose_slam::HighCmd_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x1a655499a3f64905ULL;
  static const uint64_t static_value2 = 0xdb59ceed65ca774aULL;
};

template<class ContainerAllocator>
struct DataType< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::a1_pose_slam::HighCmd_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::a1_pose_slam::HighCmd_<ContainerAllocator>& v)
  {
    s << indent << "levelFlag: ";
...
#endif // A1_POSE_SLAM_MESSAGE_HIGHCMD_H

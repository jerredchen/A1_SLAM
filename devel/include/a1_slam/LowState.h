// Generated by gencpp from file a1_slam/LowState.msg
// DO NOT EDIT!


#ifndef A1_SLAM_MESSAGE_LOWSTATE_H
#define A1_SLAM_MESSAGE_LOWSTATE_H
...
#include <a1_slam/IMU.h>
#include <a1_slam/MotorState.h>
...
struct LowState_
{
  ...
  LowState_(const ContainerAllocator& _alloc)
    ...
    , velocity_w(_alloc)  {
  (void)_alloc;
      motorState.assign( ::a1_slam::MotorState_<ContainerAllocator> (_alloc));
      ...
      eeForceRaw.assign( ::a1_slam::Cartesian_<ContainerAllocator> (_alloc));

      eeForce.assign( ::a1_slam::Cartesian_<ContainerAllocator> (_alloc));
  }
  ...
  _bandWidth_type bandWidth;
   ...
   typedef  ::a1_slam::IMU_<ContainerAllocator>  _imu_type;
  _imu_type imu;

   typedef boost::array< ::a1_slam::MotorState_<ContainerAllocator> , 20>  _motorState_type;
  ...
  _crc_type crc;
   ...
   typedef boost::array< ::a1_slam::Cartesian_<ContainerAllocator> , 4>  _eeForceRaw_type;
  _eeForceRaw_type eeForceRaw;

   typedef boost::array< ::a1_slam::Cartesian_<ContainerAllocator> , 4>  _eeForce_type;
  _eeForce_type eeForce;

   typedef  ::a1_slam::Cartesian_<ContainerAllocator>  _position_type;
  _position_type position;

   typedef  ::a1_slam::Cartesian_<ContainerAllocator>  _velocity_type;
  _velocity_type velocity;

   typedef  ::a1_slam::Cartesian_<ContainerAllocator>  _velocity_w_type;
  ...
  typedef boost::shared_ptr< ::a1_slam::LowState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::a1_slam::LowState_<ContainerAllocator> const> ConstPtr;

}; // struct LowState_

typedef ::a1_slam::LowState_<std::allocator<void> > LowState;

typedef boost::shared_ptr< ::a1_slam::LowState > LowStatePtr;
typedef boost::shared_ptr< ::a1_slam::LowState const> LowStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::a1_slam::LowState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::a1_slam::LowState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::a1_slam::LowState_<ContainerAllocator1> & lhs, const ::a1_slam::LowState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::a1_slam::LowState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::a1_slam::LowState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_slam::LowState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_slam::LowState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_slam::LowState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_slam::LowState_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::a1_slam::LowState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::a1_slam::LowState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xcef9d4f6b5a89bd6ULL;
  static const uint64_t static_value2 = 0x330896affb1bca88ULL;
};

template<class ContainerAllocator>
struct DataType< ::a1_slam::LowState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::a1_slam::LowState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::a1_slam::LowState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::a1_slam::LowState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::a1_slam::LowState_<ContainerAllocator>& v)
  {
    s << indent << "levelFlag: ";
    ...
    s << indent << "imu: ";
    s << std::endl;
    Printer< ::a1_slam::IMU_<ContainerAllocator> >::stream(s, indent + "  ", v.imu);
    ...
    for (size_t i = 0; i < v.motorState.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::a1_slam::MotorState_<ContainerAllocator> >::stream(s, indent + "    ", v.motorState[i]);
    }
    ...
    for (size_t i = 0; i < v.eeForceRaw.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.eeForceRaw[i]);
    }
    ...
    for (size_t i = 0; i < v.eeForce.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.eeForce[i]);
    }
    s << indent << "position: ";
    s << std::endl;
    Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "  ", v.position);
    s << indent << "velocity: ";
    s << std::endl;
    Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "  ", v.velocity);
    s << indent << "velocity_w: ";
    s << std::endl;
    Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "  ", v.velocity_w);
  }
};
...
#endif // A1_SLAM_MESSAGE_LOWSTATE_H

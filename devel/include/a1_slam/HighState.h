// Generated by gencpp from file a1_slam/HighState.msg
// DO NOT EDIT!


#ifndef A1_SLAM_MESSAGE_HIGHSTATE_H
#define A1_SLAM_MESSAGE_HIGHSTATE_H
...
struct HighState_
{
  ...
  HighState_(const ContainerAllocator& _alloc)
    ...
    , jointP()  {
  (void)_alloc;
      footPosition2Body.assign( ::a1_slam::Cartesian_<ContainerAllocator> (_alloc));

      footSpeed2Body.assign( ::a1_slam::Cartesian_<ContainerAllocator> (_alloc));
  ...
  _sidePosition_type sidePosition;
   ...
   typedef boost::array< ::a1_slam::Cartesian_<ContainerAllocator> , 4>  _footPosition2Body_type;
  _footPosition2Body_type footPosition2Body;

   typedef boost::array< ::a1_slam::Cartesian_<ContainerAllocator> , 4>  _footSpeed2Body_type;
  ...
  typedef boost::shared_ptr< ::a1_slam::HighState_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::a1_slam::HighState_<ContainerAllocator> const> ConstPtr;

}; // struct HighState_

typedef ::a1_slam::HighState_<std::allocator<void> > HighState;

typedef boost::shared_ptr< ::a1_slam::HighState > HighStatePtr;
typedef boost::shared_ptr< ::a1_slam::HighState const> HighStateConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::a1_slam::HighState_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::a1_slam::HighState_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::a1_slam::HighState_<ContainerAllocator1> & lhs, const ::a1_slam::HighState_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::a1_slam::HighState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::a1_slam::HighState_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_slam::HighState_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::a1_slam::HighState_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_slam::HighState_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::a1_slam::HighState_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::a1_slam::HighState_<ContainerAllocator> >
{
  ...
  static const char* value(const ::a1_slam::HighState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xe509eef5597723d8ULL;
  static const uint64_t static_value2 = 0x17fac8bddca34ac0ULL;
};

template<class ContainerAllocator>
struct DataType< ::a1_slam::HighState_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::a1_slam::HighState_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::a1_slam::HighState_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::a1_slam::HighState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::a1_slam::HighState_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.footPosition2Body.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.footPosition2Body[i]);
    }
    ...
    for (size_t i = 0; i < v.footSpeed2Body.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::a1_slam::Cartesian_<ContainerAllocator> >::stream(s, indent + "    ", v.footSpeed2Body[i]);
    }
...
#endif // A1_SLAM_MESSAGE_HIGHSTATE_H

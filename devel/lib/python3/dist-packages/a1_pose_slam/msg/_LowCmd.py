...
"""autogenerated by genpy from a1_pose_slam/LowCmd.msg. Do not edit."""
import codecs
import sys
...
float32 z"""
  ...
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','a1_pose_slam/MotorCmd[20]','a1_pose_slam/LED[4]','uint8[40]','uint32','uint32','a1_pose_slam/Cartesian[4]']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.motorCmd is None:
        self.motorCmd = [a1_pose_slam.msg.MotorCmd() for _ in range(20)]
      if self.led is None:
        self.led = [a1_pose_slam.msg.LED() for _ in range(4)]
      ...
      if self.crc is None:
        self.crc = 0
      if self.ff is None:
        self.ff = [a1_pose_slam.msg.Cartesian() for _ in range(4)]
    else:
      self.levelFlag = 0
      self.commVersion = 0
      self.robotID = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.motorCmd = []
      for i in range(0, 20):
        val1 = a1_pose_slam.msg.MotorCmd()
        _x = val1
        start = end
        end += 21

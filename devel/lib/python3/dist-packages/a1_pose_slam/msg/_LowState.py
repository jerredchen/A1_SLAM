...
"""autogenerated by genpy from a1_pose_slam/LowState.msg. Do not edit."""
import codecs
import sys
...
float32 z"""
  ...
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','a1_pose_slam/IMU','a1_pose_slam/MotorState[20]','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32','a1_pose_slam/Cartesian[4]','a1_pose_slam/Cartesian[4]','a1_pose_slam/Cartesian','a1_pose_slam/Cartesian','a1_pose_slam/Cartesian']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.motorState is None:
        self.motorState = [a1_pose_slam.msg.MotorState() for _ in range(20)]
      ...
      if self.eeForceRaw is None:
        self.eeForceRaw = [a1_pose_slam.msg.Cartesian() for _ in range(4)]
      if self.eeForce is None:
        self.eeForce = [a1_pose_slam.msg.Cartesian() for _ in range(4)]
      if self.position is None:
        self.position = a1_pose_slam.msg.Cartesian()
      if self.velocity is None:
        self.velocity = a1_pose_slam.msg.Cartesian()
      if self.velocity_w is None:
        self.velocity_w = a1_pose_slam.msg.Cartesian()
    else:
      self.levelFlag = 0
      self.commVersion = 0
      self.robotID = 0
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.motorState = []
      for i in range(0, 20):
        val1 = a1_pose_slam.msg.MotorState()
        _x = val1
        start = end
        end += 30

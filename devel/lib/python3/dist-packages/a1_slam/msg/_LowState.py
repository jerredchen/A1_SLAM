...
"""autogenerated by genpy from a1_slam/LowState.msg. Do not edit."""
import codecs
import sys
...
float32 z"""
  ...
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','a1_slam/IMU','a1_slam/MotorState[20]','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32','a1_slam/Cartesian[4]','a1_slam/Cartesian[4]','a1_slam/Cartesian','a1_slam/Cartesian','a1_slam/Cartesian']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.bandWidth is None:
        self.bandWidth = 0
      if self.imu is None:
        self.imu = a1_slam.msg.IMU()
      if self.motorState is None:
        self.motorState = [a1_slam.msg.MotorState() for _ in range(20)]
      ...
      if self.eeForceRaw is None:
        self.eeForceRaw = [a1_slam.msg.Cartesian() for _ in range(4)]
      if self.eeForce is None:
        self.eeForce = [a1_slam.msg.Cartesian() for _ in range(4)]
      if self.position is None:
        self.position = a1_slam.msg.Cartesian()
      if self.velocity is None:
        self.velocity = a1_slam.msg.Cartesian()
      if self.velocity_w is None:
        self.velocity_w = a1_slam.msg.Cartesian()
    else:
      self.levelFlag = 0
      self.commVersion = 0
      self.robotID = 0
